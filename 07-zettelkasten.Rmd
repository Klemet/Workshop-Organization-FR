...
Parfois, de temps en temps, prenez le temps d'explorer votre *Zettelkasten*. Regardez les notes liées à une étiquette en particulier pour découvrir des liens intéressants; ou bien, faite une recherche avec un mot clé pour trouver des notes similaire, et faites une note "sommaire" qui organisent celle-ci avec une structure afin de pouvoir facilement vous y retrouver. Utilisez le savoir et la connaissance que vous avez emmagasiné pour écrire des articles, des livres, des synthèses, ou bien plus encore !

3 **Faites vous confiance !**

Comme vous pouvez le voir, tous les principes et "règles" du *Zettelkasten* restent flexible, et reposent sur votre perception des choses et sur vos préférences. Cela peut être très intimidant lorsque l'on débute, et peut amener beaucoup de doutes. *Est-ce que cette notes est trop longue ? Est-ce que je devrais faire une note de cela ? Est-ce que je devrais choisir telle étiquette ?*. Toutes ces questions sont naturelles, et peuvent vous pousser à vous améliorer. Elles peuvent cependant très vite vous fatiguer et vous démotiver. Pour cela, rappelez vous que **l'action la plus importante d'un*Zettelkasten* est d'écrire et d'explorer** ! **Faites vous confiance**, et lancez vous. Quoi qu'il arrive, un *Zettelkasten* reste quelque chose de très dynamique, et vous pourrez l'éditer sans aucuns problèmes dans le futur.
...
- Dans le carnet "Notes atomiques" créez précédemment, rédigez 10 *Zettels* différentes. Essayez d'y indiquer des références, de leur trouver des étiquettes, et de faire des liens entre elles.
